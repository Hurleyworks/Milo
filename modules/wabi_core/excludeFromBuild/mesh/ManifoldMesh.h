...
public:
	...
	virtual ~ManifoldMesh();
	ManifoldMesh(ECreator eCreator = nullptr, TCreator tCreator = nullptr);

	// Support for a deep copy of the mesh.  The eMap_ and tMap_ objects have
	...
	// the mesh graph.
	ManifoldMesh(ManifoldMesh const& mesh);
	ManifoldMesh& operator=(ManifoldMesh const& mesh);
...
protected:
	...
	TCreator tCreator_;
	TMap tMap_;
	bool assertOnNonmanifoldInsertion_;  // default: true
