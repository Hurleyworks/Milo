...
template <typename T>
class Point3Tri3Dist : public Distance<T, Eigen::Matrix<T, 3, 1>  >
{

 public:
	Point3Tri3Dist (const  Eigen::Matrix<T, 3, 1> & point, const Triangle3 <T> & triangle);
	~Point3Tri3Dist ();
	
	// Object access.
	const Eigen::Matrix<T, 3, 1>& GetPoint() const { return *mPoint; }
