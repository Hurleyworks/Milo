                                      ...
                                      bool generatePTX)
{
    ...
    std::filesystem::path excludeFromBuildPath = shockerUtilFolder.parent_path().parent_path() / "Milo" / "framework" / "milo_core" / "excludeFromBuild";
    args.push_back ("--include-path");
                            ...
                            const std::string& engineFilter)
{
    ...
    std::filesystem::path cudaFolder = repoFolder / "framework" / "milo_core" / "excludeFromBuild";
