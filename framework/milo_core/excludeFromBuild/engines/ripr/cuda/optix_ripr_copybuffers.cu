...
// Shocker-specific buffer copy kernel
// Optimized for Shocker's rendering pipeline which includes flow buffers for temporal denoising
...
// Combined kernel that copies all RiPR surface buffers to linear memory in a single pass
// This is optimized for Shocker's specific buffer layout including flow vectors
