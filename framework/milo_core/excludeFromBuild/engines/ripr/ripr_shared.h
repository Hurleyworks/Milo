...
namespace ripr_shared
{
    ...
    using PrimaryRayPayloadSignature =
        optixu::PayloadSignature<ripr_shared::HitPointParams*, ripr_shared::PickInfo*>;

    using PathTraceRayPayloadSignature =
        optixu::PayloadSignature<ripr_shared::PathTraceWriteOnlyPayload*, ripr_shared::PathTraceReadWritePayload*>;
