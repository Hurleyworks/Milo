...
void RiPRModelHandler::addCgModel(RenderableWeakRef weakNode)
{
    ...
    if (node->isInstance())
    {
        ...
        RiPRModelPtr shockerModel = RiPRFlyweightModel::create();
        if (!shockerModel)
        {
    ...
    else if (node->isPhantom())
    {
        ...
        RiPRModelPtr shockerModel = RiPRPhantomModel::create();
    ...
    else
    {
        ...
        RiPRModelPtr shockerModel = RiPRTriangleModel::create();
        ...
        RiPRTriangleModel* triangleModel = dynamic_cast<RiPRTriangleModel*>(shockerModel.get());
        if (triangleModel)
        {
        ...
        shockerModel->createGAS (ctx_, scene, ripr_shared::maxNumRayTypes);
