...
// RiPRModel.h
// Base class and hierarchy for RiPR-specific model management
...
// High-performance RiPR-based triangle mesh model supporting static and dynamic geometry,
