...
namespace MiloConstants {
    constexpr uint32_t MATERIAL_SETS = 3;
}

// Base class for all Milo models
class MiloModel
{
public:
    virtual ~MiloModel()
...
// High-performance Milo-based triangle mesh model supporting static and dynamic geometry,
// material properties, and efficient acceleration structure updates
class MiloTriangleModel : public MiloModel
{
public:
    static MiloModelPtr create()
    {
        return std::make_shared<MiloTriangleModel>();
    }
...
class MiloFlyweightModel : public MiloModel
{
public:
    static MiloModelPtr create()
    {
        return std::make_shared<MiloFlyweightModel>();
    }
...
class MiloPhantomModel : public MiloModel
{
public:
    static MiloModelPtr create()
    {
        return std::make_shared<MiloPhantomModel>();
    }
