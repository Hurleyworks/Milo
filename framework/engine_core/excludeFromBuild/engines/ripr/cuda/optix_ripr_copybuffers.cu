...
// RiPR-specific buffer copy kernel
// Optimized for RiPR's rendering pipeline which includes flow buffers for temporal denoising
...
// This is optimized for RiPR's specific buffer layout including flow vectors
