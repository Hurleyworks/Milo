...
void ClaudiaTriangleModel::createGAS(RenderContextPtr ctx, optixu::Scene* scene, uint32_t numRayTypes)
{
    if (!scene)
    ...
    gasData.gas.setNumMaterialSets(ClaudiaConstants::MATERIAL_SETS);
