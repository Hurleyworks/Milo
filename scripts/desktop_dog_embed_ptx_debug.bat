...
"E:\1Milo\Milo\resources\RenderDog\ptx" "E:\1Milo\Milo\framework\engine_core\generated\embedded_ptx.h" "Debug"
echo Exit code: %ERRORLEVEL%
echo Checking if script completed...
if exist "E:\1Milo\Milo\framework\engine_core\generated\embedded_ptx.h" (
