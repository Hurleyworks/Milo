...
"E:\1Milo\Milo\resources\RenderDog\ptx" "E:\1Milo\Milo\framework\milo_core\generated\embedded_ptx.h" "Release"
echo Exit code: %ERRORLEVEL%
echo Checking if script completed...
if exist "E:\1Milo\Milo\framework\milo_core\generated\embedded_ptx.h" (
