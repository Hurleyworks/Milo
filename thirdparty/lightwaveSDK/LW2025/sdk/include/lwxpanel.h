...
#define XPTAG_SHEETFUNC         XpHTAG(380,2,0)
/* Hint Macros */
...
typedef void LWXPanelControlMouseFunc(LWXPanelID pan, unsigned int cid, int x, int y, int code);
typedef void LWXPanelControlMoveFunc(LWXPanelID pan, unsigned int cid, int x, int y);
...
#define XPANELSHEETCOLUMN_FEATURE_ALIGNMENT_MASK 0xF0000000

#define XPANELSHEETCOLUMN_FEATURE_ALIGN_LEFT   0x10000000
#define XPANELSHEETCOLUMN_FEATURE_ALIGN_CENTER 0x20000000
#define XPANELSHEETCOLUMN_FEATURE_ALIGN_RIGHT  0x30000000
...
/* Global Services */
/* wrapper: type=ignore, name=LWXPanelFuncs, arg=drawf */
