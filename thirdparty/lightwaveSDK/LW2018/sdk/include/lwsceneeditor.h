...
typedef struct st_SEColumn {
  ...
  const char          *description /* language encoded */;
...
typedef struct st_SEBank
{
  ...
  const char    *category /* language encoded */;                  /* name of category this bank belongs to.  can be NULL.  Banks with same category name are grouped together */
  const char    *title /* language encoded */;                     /* Bank Title, for display purposes.  Used in the Bank Popup. Also used to organize column selection */
