...
#define LWOBJECTIMPORT_VERSION  4
...
typedef struct st_LWObjectImport {
    ...
    void        (*surface) (void *, const char *basename /* language encoded */, const char *refname /* language encoded */, int chunk_size, void *surf_chunk, unsigned int version);
