...
typedef struct st_LWMeshInfo
{
    ...
    void *          (*pntVLookup)   (LWMeshInfoID, LWID vmap_type, const char *vmap_name /* language encoded */);
     ...
     */
    void *          (*pntVIDLookup)   (LWMeshInfoID, LWID vmap_type, const char *vmap_name /* language encoded */);
...
#define LWOBJECTFUNCS_GLOBAL    "Scene Objects 8"
...
#define LWMESHFUNCS_GLOBAL "Mesh Functions 1"
...
typedef struct st_LWMeshFuncs
{
    ...
    LWVMapID        (*vmap_lookup)          (LWMeshID mesh, LWID vmap_type, const char* vmap_name);
