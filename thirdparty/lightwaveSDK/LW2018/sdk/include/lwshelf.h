...
typedef struct st_LWShelfFuncs {
  ...
  LWShelfCltID (*subscribe)      ( const char *name /* language encoded */, const char *subName /* language encoded */,
  ...
  void         (*load)           ( LWShelfCltID clt, const char *filename /* language encoded */, int prompt_user );
  void         (*save)           ( LWShelfCltID clt, const char *filename /* language encoded */, LWImageID thumimg, LWShelfParmList parms );
