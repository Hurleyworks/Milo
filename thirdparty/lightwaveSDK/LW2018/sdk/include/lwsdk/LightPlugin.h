...
namespace lwsdk
{
    ...
    public:
        ...
        LWError new_frame(const LWFrameInfo* frameinfo, unsigned int* maxIlluminations) { return 0; }
        const LWPreviewLight* preview() { return 0; }
    ...
    public:
        ...
        LightPluginAdaptor(const char* plugin_name_, const char* user_name_, ServerTagInfo* additional = NULL) :
        ...
        static LWInstance create(void* data, void* context, LWError* err)
        {
            ...
            LWItemID id = static_cast<LWItemID>(ctx->context);
