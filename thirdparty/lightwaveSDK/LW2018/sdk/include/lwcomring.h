...
{
    int         (*ringAttach)   (const char *topic /* ? encoded */,LWInstance pidata,RingEvent eventCallback);
    void        (*ringDetach)   (const char *topic /* ? encoded */,LWInstance pidata);
    void        (*ringMessage)  (const char *topic /* ? encoded */,int eventCode,void *eventData);
} LWComRing;
