...
#define LWNODECLASS_VERSION     4

#define LWNODEFUNCS_GLOBAL          "NodeFuncs 2"
#define LWNODEINPUTFUNCS_GLOBAL     "NodeInputFuncs 5"
#define LWNODEOUTPUTFUNCS_GLOBAL    "NodeOutputFuncs 4"
#define LWNODEUTILITYFUNCS_GLOBAL   "NodeUtilityFuncs 2"
...
typedef struct LWNodeDrawFuncs_t {
    ...
    int    (*textWidth)( NodeID node, const char *s /* language encoded */ );
    int    (*textHeight)( NodeID node, const char *s /* language encoded */ );
    void   (*drawText)( NodeID node, const char *s /* language encoded */, int c, int x, int y );
...
typedef struct LWNodeUtilityFuncs_t {
    ...
    int     (*uvMapping)(const char* uvMapName /* language encoded */, double utiles, double vtiles, double uoffset, double voffset,
