...
#define LWVIEWPORTOBJECT_VERSION 5
...
typedef struct st_LWViewportObjectAccess {
    int          (*showFrame   )( struct st_LWVPAHostAccess *, unsigned int, unsigned int, float *, unsigned int, float *, unsigned int, unsigned int, unsigned int, float *minimum, float *maximum );
...
typedef struct st_LWViewportHandler {
    ...
    int          (*previewBackground)( LWInstance, LW_BACKGROUND backgound, float *color );
    int          (*previewObject)( LWInstance, LWItemID object );
    int          (*previewLight)(  LWInstance, LWItemID );
    int          (*previewSurface)(LWInstance, LWSurfaceID );
    int          (*previewMode)(   LWInstance, int );
} LWViewportHandler;
