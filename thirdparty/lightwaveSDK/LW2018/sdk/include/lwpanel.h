...
#define LWPANELS_API_VERSION    22
...
typedef struct st_LWPanPopupDesc {
    ...
    int             width;
    int             (*countFn)(void *);
    const char     * /* language encoded */(*nameFn)(void *, int);
    const char     *(*faceFn)(void *, int);
    int             (*typeFn)(void *, int);
...
typedef struct st_LWPanMultiListBoxDesc {
    ...
    int             width, visItems, top;  // width in pixels, height in items, top visible item
    int             (*countFn)(void *);
    const char     * /* language encoded */(*nameFn)(void *, int item, int column);
    int             (*colWidth)(void *, int i);  // pixel width of column i, terminate with 0
...
typedef struct st_LWPanTreeDesc {
    ...
    const char     * /* language encoded */ (*infoFn)(void *data, void *node, int *nodeFlags); /* return "name" for node, fill 0 flags, or save non-zero flags */
...
typedef struct st_LWPanMultiTreeDesc {
    ...
    int             (*countFn)(void *data, void *node); /* return number of leafs under given node, NULL node is root */
    void           *(*leafFn)(void *data, void *node, int i); /* return leaf i of node, NULL node is root */
    const char     * /* language encoded */ (*infoFn)(void *data, void *node, int column, int *nodeFlags); /* return "name" for node, fill 0 flags, or save non-zero flags */
    void            (*moveFn)(void *data, void *node, void *parentNode, int i); /* NULL prevents moves, or called when user moves node, with new parent, position */
    int             (*colWidth)(void *, int i);  // pixel width of column i, terminate with 0
} LWPanMultiTreeDesc;
...
typedef struct st_DrawFuncs {
    ...
    int     (*textWidth)(LWPanelID,const char *text /* language encoded */);             /* text */
    void    (*drawText)(LWPanelID,const char *text /* language encoded */,int,int,int);  /* text,color,x,y */
...
typedef struct st_LWPanelFuncs {
    LWPanelID               (*create)(const char *title /* language encoded */, void *);
    ...
    LWControl              *(*addControl)(LWPanelID pan, const char *type /* ascii encoded */, ControlDesc *data, const char *label /* language encoded */);
...
typedef struct st_LWRasterFuncs {
    ...
    void            (*drawText)( LWRasterID raster, const char *text /* utf-8 */, int color, int x, int y);
